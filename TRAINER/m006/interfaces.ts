...
let Max: Person = { lastName: 'Mustermann', firstName: 'Max', address: 'Hauptstraße 1', age: 25, getFullName: function () { return this.firstName + ' ' + this.lastName } }

console.log('Max.getFullName()', Max.getFullName())

Max.age = 26;
// Max.address = 'Nebenstraße 1' // Fehler: Cannot assign to 'address' because it is a read-only property.ts(2540)
